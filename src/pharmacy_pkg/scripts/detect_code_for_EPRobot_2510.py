...
# 添加全局变量
detection_enabled = False  # 识别使能标志
...
# 订阅控制命令话题
control_sub = rospy.Subscriber('/detection_control', Bool, detection_control_callback, queue_size=10)
    ...
    if display:
        ...
        if(len(dingweikuang)==48):
            ...
            if detection_enabled:  # 检查识别使能标志
                ...
                rospy.loginfo("Detection disabled.")
