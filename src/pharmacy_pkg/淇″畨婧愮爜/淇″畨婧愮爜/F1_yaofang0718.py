...
class MoveBaseSquare():
    ...
    def __init__(self):
        ...
        waypoints.append(Pose(Point(-0.040,3.899,0), quaternions[8]))  #答题区(识别板2) 靠近里侧（-0.704,3.963,0） （0）靠近内侧 y减小(-0.784,3.750,0.1)
        waypoints.append(Pose(Point(1.07,0.145,0), quaternions[9]))  #识别板1向前一点0.6 ()x:0.65 y:0.025
