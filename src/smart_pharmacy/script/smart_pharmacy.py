...
class MoveBaseSquare():
    ...
    def __init__(self):
        ...
        # 创建一个列表存储导航点的位置
        waypoints = list()
        waypoints.append(Pose(Point(-1.091, 2.142, 0), quaternions[0]))      # //C
        waypoints.append(Pose(Point(-0.508, 1.559, 0), quaternions[1]))      #//A
        waypoints.append(Pose(Point(-1.395, 1.378, 0), quaternions[2]))      # //B
        waypoints.append(Pose(Point(1.578, 2.916, 0), quaternions[3]))     # //4
        waypoints.append(Pose(Point(2.254, 2.239, 0), quaternions[4]))    # //3
        waypoints.append(Pose(Point(1.378, 1.955, 0), quaternions[5]))    # //2
        waypoints.append(Pose(Point(1.958, 1.155, 0), quaternions[6]))    # //1
        waypoints.append(Pose(Point(0.924,3.939,0), quaternions[7]))    #起点
        waypoints.append(Pose(Point(0.116,-0.094,0), quaternions[8]))  #答题区   
        waypoints.append(Pose(Point(0.480,4.067,0), quaternions[9]))  #识别板1           
